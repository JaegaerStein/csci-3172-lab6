# Activity 9 / Lab / Assignment / Project Title

**[Optional]** If what is being submitted is an individual Lab or Assignment. Otherwise, include a brief one paragraph description about the project.

* *Date Created*: 07 02 2025
* *Last Modification Date*: 07 02 2025
Git URL: https://git.cs.dal.ca/steinhauer/csci-3172/-/tree/main/activities/lecture9
Timberlea URL: https://web.cs.dal.ca/~steinhauer/csci3172/activities/lecture9/

I added another page which is directed to after submitting the form with all fields filled. Added conditional to prevent submittion if all fields are not full.
Also added the color change and reset to the form. 
